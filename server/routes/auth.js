...
import { login, logout, signup, verifyEmail, forgotPassword, resetPassword, 
    ...
    setInboxReadStatus,
    checkUserAcceptInviteStatus,
    checkUserRejectInviteStatus} from '../controllers/authController.js';
...
router.get("/check-inbox-accept-invite/:specificEventURL", verifyToken, checkUserAcceptInviteStatus);
router.get("/check-inbox-decline-invite/:specificEventURL", verifyToken, checkUserRejectInviteStatus);
